...
python scripts/train.py -n 1 -o trained_models/m1bog -m backoff -b 0.1 -a 1
echo "Training Model 2-BackOffNGram"
python scripts/train.py -n 2 -o trained_models/m2bog -m backoff -b 0.7 -a 1
echo "Training Model 3-BackOffNGram"
python scripts/train.py -n 3 -o trained_models/m3bog -m backoff -b 0.8 -a 1
echo "Training Model 4-BackOffNGram"
python scripts/train.py -n 4 -o trained_models/m4bog -m backoff -b 0.8 -a 1
